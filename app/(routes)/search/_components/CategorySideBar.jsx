      ...
      <div>
        {categoryList.map((category, index) => (
          <Link
            ...
            key={index}
            className={`flex gap-2 p-3 border rounded-lg mb-3 mr-10 cursor-pointer hover:bg-purple-50 hover:shadow-md items-center hover:text-primary hover:border-primary
            ${
